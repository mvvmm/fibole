...
export function FactList({ facts, mode, selectedIndex, correctIndex, onSelect }: FactListProps) {
  return (
        ...
        return (
          <li key={i}>
            ...
            >
              ...
              <span className="flex-1 text-sm text-slate-700 leading-relaxed pt-0.5">{fact}</span>
              {indicator && (
